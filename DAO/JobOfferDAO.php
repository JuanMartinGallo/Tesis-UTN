<?php 
    ...
    class JobOfferDAO implements IJobOfferDAO
    {
        ...
        public function add(JobOffer $jobOffer)
        {
            try
            {
                $query = "INSERT INTO ".$this->tableName." (jobOfferId, jobPosition, company, city, salary, isRemote, description, active) VALUES (:jobOfferId, :jobPosition, :company, :city, :salary, :isRemote, :description, :active);";
